...
" Yank error when hover the error
nnoremap <silent> <space>yd :call StatusDiagnosticToClipboard()<CR>
...
augroup mygroup
  ...
  autocmd FileType json,java,xml,jsp setl formatexpr=CocAction('formatSelected')
